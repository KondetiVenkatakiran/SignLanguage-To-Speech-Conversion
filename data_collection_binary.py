...
cv2.imwrite("\\Users\\venkatakirankondeti\\Documents\\SignLanguage To Speech Conversion\white.jpg",white)
...
while True:
    try:
        ...
        if hands:
            ...
            x, y, w, h = hand['bbox']
            image = frame[y - offset:y + h + offset, x - offset:x + w + offset]
            white = cv2.imread(image_path)("\\Users\\venkatakirankondeti\\Documents\\SignLanguage To Speech Conversion\white.jpg")
            # img_final=img_final1=img_final2=0
